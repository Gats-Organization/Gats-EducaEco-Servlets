...
<html>
    <head>
        ...
        <!-- Após o processamento no servlet "ServletListarProfessor", se tudo correr bem o usário será direcionado para esta página -->
    ...
    <body>
        ...
        <!-- Tabela listando os dados dos professores -->
        <table border="1">
            <tr id="colunas">
                <th>Id</th>
                <th>Nome</th>
            ...
            <!-- Criando uma lista do tipo ProfessorDTO que receberá a listagem da tabela -->
            <%
            ...
            <tr>
                ...
                <!-- Formulário que dá ao usuário a opção de editar o professor que desejar -->
                <td>
                ...
                <!-- Botão que exclui o professor que o usuário desejar, usando uma function -->
                <td id="excluir">
        ...
        <!-- Script que cria uma função, que redireciona para o servlet ExcluirProfessor após receber uma confirmação do usuário -->
        <script type="text/javascript">
            function confirmarExclusao(id) {
                document.getElementById("modalExclusao").style.display = "block";
                document.getElementById("confirmado").onclick = function() {
                    location.href = "excluirProfessor?id=" + id;
                }
            }
        ...
        <!-- Botão que redireciona para a página de adicionar professor -->
